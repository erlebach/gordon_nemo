...
# 5. Define the NeMo-Run recipe function using run.autoconvert
...
def dummy_recipe(
    ...
    # Pre-compute accelerator type outside of Config to avoid control flow issues
    # accelerator_type = "gpu" if torch.cuda.is_available() else "cpu"
    accelerator_type = "cpu"

    # Configure the trainer as a run.Config object
