...
class DataBase:
    @classmethod
    def create_sine_data(cls, n=1000, noise=0.1):
    ...
    @classmethod
    def prepare_data(cls, train_size=1000, val_size=200, test_size=200, noise=0.1):
...
class DataFinetune:
    ...
    def prepare_finetune_data(
        cls, train_size=1000, val_size=200, test_size=200, noise=0.1, phase=0.5
    ):
...
if __name__ == "__main__":
    ...
    base_train_data = np.load("data/sine_train.npz")
    base_val_data = np.load("data/sine_val.npz")
    base_test_data = np.load("data/sine_test.npz")
